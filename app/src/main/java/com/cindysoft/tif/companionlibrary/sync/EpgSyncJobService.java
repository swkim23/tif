...
package com.cindysoft.tif.companionlibrary.sync;
...
import com.cindysoft.tif.companionlibrary.model.Channel;
import com.cindysoft.tif.companionlibrary.model.ModelUtils;
import com.cindysoft.tif.companionlibrary.model.ModelUtils.OnChannelDeletedCallback;
import com.cindysoft.tif.companionlibrary.model.Program;
import com.cindysoft.tif.companionlibrary.utils.Constants;
...
public abstract class EpgSyncJobService extends JobService {
    ...
    /**
     * The name for the {@link SharedPreferences} file used for storing syncing
     * metadata.
     */
