 ...
 */
package com.cindysoft.tif.companionlibrary.setup;
...
import com.cindysoft.tif.companionlibrary.sync.SyncStatusBroadcastReceiver;
import com.cindysoft.tif.companionlibrary.sync.SyncStatusBroadcastReceiver.SyncListener;
import java.util.ArrayList;
import java.util.List;

// Gradle puts all resources in the base package, so companionlibrary.R must be imported.
import com.cindysoft.tif.R;
